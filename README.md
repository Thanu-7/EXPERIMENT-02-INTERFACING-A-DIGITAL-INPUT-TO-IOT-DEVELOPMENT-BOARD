...
**NAME: THANUSHREE VIJAYAKNATH**

**ROLL NO: 212224110054**
...
void digi_inp()
{
	...
	if (IR_SENSOR==0)
	{
		HAL_PIN_WritePin(GPIO,GPIO_PIN_0,GPIO_PIN_SET);
	}
	else
	{
...
<img width="1042" height="988" alt="image" src="https://github.com/user-attachments/assets/f72e460a-57a7-4e9f-b1cb-db3fb210913d" />

<img width="1035" height="840" alt="image" src="https://github.com/user-attachments/assets/3190be71-3832-4f5d-95a2-e2fb9b902591" />
